; ModuleID = './samples/input_for_hello.c'
source_filename = "./samples/input_for_hello.c"
...
!1 = !{!"Ubuntu clang version 11.1.0-++20211011094159+1fdec59bffc1-1~exp1~20211011214622.5"}
