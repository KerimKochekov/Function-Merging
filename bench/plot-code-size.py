...
gorder = ['FMSA [t=1]','FMSA [t=5]','FMSA [t=10]','SalSSA [t=1]','SalSSA [t=5]','SalSSA [t=10]', 'LCS [t=1]', 'LCS [t=5]', 'LCS [t=10]']
...
BlueRedPallete = ['#76ABCA','#045C90','#021C2C','#FB8E7F','#E32D14','#440E06','#FB8E7F','#E32D14','#440E06']
