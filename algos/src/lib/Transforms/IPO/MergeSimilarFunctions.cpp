...
static cl::opt<bool> Verbose("mergesimilarfunc-verbose", cl::Hidden,
                                    cl::init(false));
...
static void SplitBlockAndInsertSwitch(
  ...
  // If Inst1 (and Inst2s) are Terminators, Tail will be empty and can be
