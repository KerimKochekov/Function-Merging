...
struct FunctionMergingBranchReord : public ModulePass {
  static char ID;
  FunctionMergingBranchReord() : ModulePass(ID) {}

  bool runOnModule(Module &M) override;
  // TODO: uncomment later after adding implementation of getAnalysisUsage
...
static cl::opt<unsigned> ExplorationThreshold(
    "function-merging-branch-reord-explore", cl::init(1), cl::Hidden,
    cl::desc("Exploration threshold of evaluated functions"));


static cl::opt<unsigned> SAMethod(
    "function-merging-branch-reord-sa-method", cl::init(0), cl::Hidden,
    cl::desc("(0) hirschberg; (1) needleman-wunsch;"));

static cl::opt<unsigned> RankingThreshold(
    "function-merging-branch-reord-ranking-threshold", cl::init(0), cl::Hidden,
    cl::desc("Threshold of how many candidates should be ranked"));


static cl::opt<int> MergingOverheadThreshold(
    "function-merging-branch-reord-threshold", cl::init(0), cl::Hidden,
    cl::desc("Threshold of allowed overhead for merging function"));

static cl::opt<bool>
    MaxParamScore("function-merging-branch-reord-max-param", cl::init(true), cl::Hidden,
                  cl::desc("Maximizing the score for merging parameters"));

static cl::opt<bool> Debug("function-merging-branch-reord-debug", cl::init(true), cl::Hidden,
                           cl::desc("Outputs debug information"));

static cl::opt<bool> Verbose("function-merging-branch-reord-verbose", cl::init(false),
                             cl::Hidden, cl::desc("Outputs debug information"));

static cl::opt<bool>
    IdenticalType("function-merging-branch-reord-identic-type", cl::init(true), cl::Hidden,
                  cl::desc("Match only values with identical types"));

static cl::opt<bool> ApplySimilarityHeuristic(
    "function-merging-branch-reord-similarity-pruning", cl::init(true), cl::Hidden,
    cl::desc("Prune the candidates based on their fingerprint similarity"));


static cl::opt<bool>
    EnableUnifiedReturnType("function-merging-branch-reord-unify-return", cl::init(false), cl::Hidden,
                  cl::desc("Enable unified return types"));

static cl::opt<bool>
    EnableOperandReordering("function-merging-branch-reord-operand-reorder", cl::init(true), cl::Hidden,
                  cl::desc("Enable operand reordering"));

static cl::opt<bool>
    HasWholeProgram("function-merging-branch-reord-whole-program", cl::init(false), cl::Hidden,
                  cl::desc("Function merging applied on whole program"));

static cl::opt<bool>
    EnableSALSSA("function-merging-branch-reord-salssa", cl::init(false), cl::Hidden,
                  cl::desc("Enable full support of the SSA form with SalSSA"));

static cl::opt<bool>
    EnableSALSSACoalescing("function-merging-branch-reord-coalescing", cl::init(true), cl::Hidden,
...
public:
  ...
  template<typename BlockListType>
  class FMSACodeGen : public FunctionMerger::CodeGenerator<BlockListType> {
  public:
...
void FunctionMergingBranchReord::getAnalysisUsage(AnalysisUsage &AU) const {
...
static RegisterPass<FunctionMergingBranchReord>
    X("function-merging-branch-reord", "Function Merging with Branch Reordering Pass",
