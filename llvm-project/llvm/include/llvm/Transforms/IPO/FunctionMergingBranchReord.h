...
struct FunctionMergingOptionsBranchReord {
  ...
  FunctionMergingOptionsBranchReord &matchOnlyIdenticalTypes(bool IT) {
    IdenticalTypesOnly = IT;
    return *this;
  }

  FunctionMergingOptionsBranchReord &enableUnifiedReturnTypes(bool URT) {
    EnableUnifiedReturnType = URT;
    return *this;
  }
};

class FunctionMergeResultBranchReord {
private:
  Function *F1;
  Function *F2;
